'''Following Code is a part of VADER Sentiment analysis package'''
#############################################################################################################
#************************************************************************************************************
...
class SentimentIntensityAnalyzer(object):
    ...
    """
    def __init__(self, lexicon_file="lexicons"):
...
if __name__ == '__main__':
    sentiment_file = open('/home/yasar/sentiment_data').read()
    sentences = sentiment_file.split('\n')
    sentences = [i for i in sentences if i!='' and i!=None]
    ...
    df_list =  [('S_No',serial),
                ('Sentence',sentences),
                ('Negative_Sentiment_Score', negative_scores),
                ('Positive_Sentiment_Score', positive_scores),
                ('Neutral_Sentiment_Score', neutral_scores),
                ('COMPOUND_SCORE', compound_scores)]
    df = pd.DataFrame.from_items(df_list)
    df.to_csv('/home/yasar/Sentiment_Analysis_Result.csv')
    print("----------------------------------------------------")
